...
![deploy](/images/5.4-lambda/deploy.png)
#### Create Trigger
+ Right above the code section, click the **+ Add trigger** button.
![addtrigger](/images/5.4-lambda/add-trigger.jpg)
+ Source: Select **S3**.
+ Bucket: Select the bucket **s3-demo-text**.
![addtrigger](/images/5.4-lambda/create-trigger.jpg)
+ Event types: Select **All object create events**.
![addtrigger](/images/5.4-lambda/event-types.jpg)
+ Prefix: Enter ```input/```
...
+ Suffix: Enter ```.txt```
![addtrigger](/images/5.4-lambda/prefix-suffix.jpg)
+ Check the box **"I acknowledge..."** -> Click **Add**.
![addtrigger](/images/5.4-lambda/add-success.jpg)