...
pre : " <b> 1. </b> "
---
- **Tuần 1:** [Làm quen với AWS và các dịch vụ cơ bản của AWS](Week1/_index.vi.md)  
- **Tuần 2:** [Tìm hiểu các dịch vụ AWS cơ bản (S3, RDS, CloudWatch, Lightsail, EC2 Auto Scaling) và thực hành xây dựng backend với Spring Boot và PostgreSQL.](Week2/_index.vi.md)  
...
- **Tuần 8:** [Củng cố kiến thức AWS về kiến trúc bảo mật và chịu lỗi, thực hành lab EC2 và S3, tích hợp AWS Cognito, và hoàn thành bài thi giữa kỳ AWS.](Week8/_index.vi.md)  
